...
!function(a, b, c, d) {
    ...
    function i(c) {
        if (A.length) {
            ...
            for (d = 0, e = A.length; e > d; d++) {
                var l, m = A[d], o = m[0], q = m[n], s = !1, u = c;
                if (z(r, o)) {
                    if (c || !q.visibleOnly || o.offsetWidth || o.offsetHeight) {
                        if (!u) {
                            var v = o.getBoundingClientRect(), x = q.edgeX, y = q.edgeY;
                            l = v.top + i - y - j, u = i >= l && v.bottom > -y && v.left <= k + x && v.right > -x;
                        }
                        if (u) {
                            g("show", m);
                            var C = q.srcAttr, D = w(C) ? C(m) : o.getAttribute(C);
    ...
    function k(a) {
        A.length && (a && "scroll" === a.type && a.currentTarget === b && B >= f() || (C || setTimeout(j, 0), 
        C = 2));
    }
    function l() {
        v.lazyLoadXT();
    ...
    var n = "lazyLoadXT", o = "lazied", p = "load error", q = "lazy-hidden", r = c.documentElement || c.body, s = b.onscroll === d || !!b.operamini || !r.getBoundingClientRect, t = {
        autoInit: !0,
        ...
        edgeY: 200,
        visibleOnly: !0
    }, v = a(b), w = a.isFunction, x = a.extend, y = a.data || function(b, c) {
        return a(b).data(c);
    ...
    a[n] = x(t, u, a[n]), a.fn[n] = function(c) {
        c = c || {};
        var d, f = e(c, "blankImage"), h = e(c, "checkDuplicates"), i = e(c, "scrollContainer"), j = {};
        a(i).on("scroll", k);
        ...
        return this.each(function(d, e) {
            if (e === b) a(t.selector).lazyLoadXT(c); else {
                if (h && y(e, o)) return;
                var i = a(e).data(o, 1);
                f && "IMG" === e.tagName && !e.src && (e.src = f), i[n] = x({}, j), g("init", i), 
                A.push(i);
            }
        });
    }, a(c).ready(function() {
        g("start", v), v.on(t.loadEvent, l).on(t.updateEvent, k).on(t.forceEvent, m), a(c).on(t.updateEvent, k), 
        t.autoInit && l();
    });
    ...
    b.selector += ",video,iframe[data-src]", b.videoPoster = "data-poster", a(document).on("lazyshow", "video", function(c, d) {
        var e = d.lazyLoadXT.srcAttr, f = a.isFunction(e);
...
!function(a, b, c, d) {
    ...
    function h(d) {
        ...
        return u = l[0].url, k.srcsetExtended && (u = (d.attr(k.srcsetBaseAttr) || "") + u + (d.attr(k.srcsetExtAttr) || "")), 
        u;
    }
    var i, j, k = a.lazyLoadXT, l = function() {
        return "srcset" in new Image();
    }(), m = /^\s*(\S*)/, n = /\S\s+(\d+)w/, o = /\S\s+(\d+)h/, p = /\S\s+([\d\.]+)x/, q = [ 0, 1 / 0 ], r = [ 0, 1 ], s = {
...
DM.provide("Cookie", {
    ...
    load: function() {
        var a = decodeURIComponent(unescape(document.cookie)).match("\\bdms_" + DM._apiKey + '="([^;]*)\\b'), b;
        if (a) {
            b = DM.QS.decode(a[1]);
    ...
    setRaw: function(c, a, b) {
        document.cookie = "dms_" + DM._apiKey + '="' + c + '"' + (c && a == 0 ? "" : "; expires=" + new Date(a * 1e3).toGMTString()) + "; path=/" + (b ? "; domain=." + b : "");
        DM.Cookie._domain = b;
    },
    set: function(a) {
        if (a) {
...
DM.provide("", {
    init: function(a) {
        ...
        if (DM._apiKey) {
            ...
            a.session = a.session || DM.Auth._receivedSession || DM.Cookie.load();
            DM.Auth.setSession(a.session, a.session ? "connected" : "unknown");
            if (a.status) {
                DM.getLoginStatus();
            }
        }
...
DM.provide("QS", {
    ...
    decode: function(f) {
        var c = decodeURIComponent, e = {}, b = f.split("&"), a, d;
...
DM.provide("ApiServer", {
    ...
    jsonp: function(k, a, d, c) {
        ...
        var b = DM.ApiServer.getSimpleCallURL(k, d);
        if (b.length > 2e3) {
    ...
    performMultipleCalls: function(d) {
        ...
        g.onreadystatechange = function() {
            if (g.readyState == 4) {
                ...
                if (g.status) {
                    try {
                        p = DM.JSON.parse(g.responseText);
                    } catch (q) {}
                }
                var n = DM.type(p);
                if (n == "array") {
                    for (var o = 0, k = p.length; o < k; o++) {
                        var m = p[o];
                        e = "id" in m && d[m.id] ? d[m.id] : null;
                        if (!e) {
                            DM.error("Response with no valid call id: " + DM.JSON.stringify(m));
                            continue;
                        }
                        if (e.cb) {
                            if ("result" in m) {
...
DM.provide("", {
    ...
    getSession: function() {
        if (DM._session && "expires" in DM._session && new Date().getTime() > DM._session.expires * 1e3) {
    ...
    login: function(g, a) {
        ...
        if (a.display === "popup") {
            var h = window.open(DM._domain.oauthAuthorizeUrl + "?" + DM.QS.encode(a), "dmauth", c);
            ...
            location.href = DM._domain.oauthAuthorizeUrl + "?" + DM.QS.encode(a);
        }
    },
    logout: function(a) {
        DM.api("/logout", a);
...
DM.provide("Auth", {
    ...
    loadSiteSession: function() {
        if (window.location.host.match(/dailymotion\.com$/)) {
            var a = document.cookie.match(/\bsid=([a-f0-9]+)/);
            if (a) {
                DM.Auth.setSession({
                    access_token: a[1]
                });
    ...
    recvSession: function(a) {
        ...
        if ("error" in a) {
            DM.error("Received auth error `" + a.error + "': " + a.error_description);
        }
        if (!("state" in a)) {
            DM.error("Received a session with not `state' field");
            return;
        }
        if (!(a.state in DM.Auth._active)) {
            DM.error("Received a session from an inactive window");
            return;
        }
        DM.Auth._active[a.state].session = a;
    },
    setSession: function(h, c) {
        var e = !DM._session && h, b = DM._session && !h, g = false, a = e || b || DM._session && h && DM._session.access_token != h.access_token, f = c != DM._userStatus;
        if (h && "expires_in" in h) {
            h.expires = Math.round(new Date().getTime() / 1e3) + parseInt(h.expires_in, 10);
            delete h.expires_in;
        }
        var d = {
            session: h,
        ...
        DM._session = h;
        DM._userStatus = c;
        if (a && DM.Cookie && DM.Cookie.getEnabled()) {
            DM.Cookie.set(h);
        }
        if (f) {
            DM.Event.fire("auth.statusChange", d);
        }
        if (b || g) {
            DM.Event.fire("auth.logout", d);
        }
        if (e || g) {
            DM.Event.fire("auth.login", d);
        }
        if (a) {
            DM.Event.fire("auth.sessionChange", d);
        }
        return d;
    },
...
DM.provide("XDCom", {
    _swfPath: "/xdcom.swf",
    createChannel: function(f, g) {
        if (!DM.XDCom.capable()) {
            return;
        }
        var d = "", h = DM.guid(), b = "id=" + h;
        if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
            d = '<embed type="application/x-shockwave-flash" id="DMXDCom" width=0 height=0 src="' + DM._domain.cdn + DM.XDCom._swfPath + '" flashvars="' + b + '" allowscriptaccess="always"></embed>';
        } else {
            d = '<object id="DMXDCom" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">  <param name="movie" value="' + DM._domain.cdn + DM.XDCom._swfPath + '"></param>  <param name="flashvars" value="' + b + '"></param>  <param name="allowScriptAccess" value="always"></param></object>';
        }
        var c, a = document.createElement("div"), e = a.style;
        e.position = "absolute";
        e.top = "-10000px";
        e.width = e.height = 0;
        document.body.appendChild(a);
        window.onDMXDComMessage = f;
        window.onDMXDComReady = function() {
            c.addListener("onDMXDComMessage");
            if (g) {
                g();
            }
        };
        a.innerHTML = d;
        c = document.getElementById("DMXDCom");
        c.connectionId = h;
        return c;
    },
    capable: function() {
...
DM.provide("Player", {
    ...
    create: function(d, b) {
        ...
        DM.Array.forEach([ "id", "style", "class" ], function(e) {
            var f = d.getAttribute(e);
            if (f) {
                c.setAttribute(e, f);
            }
        });
        ...
        c.setAttribute("webkitallowfullscreen", "true");
        c.setAttribute("mozallowfullscreen", "true");
    ...
    init: function(b, c) {
        ...
        if (DM.Player.API_MODE == "xdcom") {
            c.xdcomId = DM.Player.xdcomChannel.connectionId;
        }
        if (DM._apiKey) {
            c.apiKey = DM._apiKey;
        }
    ...
    _installHandlers: function(b) {
        ...
        if (window.postMessage) {
            ...
            var a = function(f) {
                if (!f.origin || f.origin.indexOf(DM.Player._PROTOCOL + DM._domain.www) !== 0) {
                    return;
                }
                var d = DM.QS.decode(f.data);
                if (!d.id || !d.event) {
                    return;
                }
                var c = DM.$(d.id);
            ...
            if (DM.XDCom.capable()) {
                ...
                DM.Player.xdcomChannel = DM.XDCom.createChannel(function(e) {
                    var d = DM.QS.decode(e);
                    if (!d.id || !d.event) {
                        return;
                    }
                    var c = DM.$(d.id);
        ...
        if (DM.Player.API_MODE === null) {
            ...
            if (!DM.Player._INTERVAL_ID) {
                DM.Player._INTERVAL_ID = setInterval(function() {
                    for (var f in DM.Player._INSTANCES) {
                        var c = DM.Player._INSTANCES[f], e;
                        if ((e = c.src.indexOf("#")) != -1) {
                            var d = DM.QS.decode(src.substring(e + 1));
                            c.src = src.substring(0, e);
                            if (d.id && d.event) {
                                c._recvEvent(d);
                            }
                        }
                    }
                    if (DM.Player._INSTANCES.length === 0) {
                        clearInterval(DM.Player._INTERVAL_ID);
                    }
                }, 0);
            }
        }
    ...
    _send: function(b) {
        switch (DM.Player.API_MODE) {
          case "postMessage":
            this.contentWindow.postMessage(b, DM.Player._PROTOCOL + DM._domain.www);
            break;

          case "xdcom":
            DM.Player.xdcomChannel.postMessage(this.id, b);
            break;
...
(function($, window, document, undefined) {
    var pluginName = "addClassScrolling", defaults = {
        className: "is-active",
        repeat: false,
        start: "top",
        offset: 0
    ...
    $.extend(Plugin.prototype, {
        ...
        setEvents: function() {
            ...
            $(window).on("scroll", $.proxy(function() {
                ...
                var scrollDelta = newScrollTop - scrollTop;
                scrollTop = newScrollTop;
                var eleTop = this.$element.offset().top;
                var eleHeight = this.$element.height();
                var eleBottom = eleTop + eleHeight;
                var offset = this.windowWidth > 768 ? this.settings.offset : 0;
                var eleStart = this.settings.start == "bottom" ? eleBottom + offset : eleTop + offset;
                if (scrollTop + this.windowHeight >= eleStart && scrollTop <= eleStart) {
...
(function($, window, document, undefined) {
    var pluginName = "popin", defaults = {
        tplPopin: '<div class="js-popin popin"></div>',
        tplPopinHead: "",
        tplPopinFoot: "",
        tplFog: '<div class="js-fog fog"></div>',
    ...
    $.extend(Plugin.prototype, {
        init: function() {
            if (!$(".js-popin").length) $("body").append(this.settings.tplPopin);
            this.setElements();
            this.setEvents();
        },
        setElements: function() {
        ...
        setEvents: function() {
            this.$document.on("click", "*[data-popin]", $.proxy(function(e) {
                this.$trigger = $(e.currentTarget);
                var condition = this.$trigger.attr("data-popin-condition") ? this.$trigger.data("popin-condition") : "";
                if (!condition || $(condition).length) {
                    var url = this.$trigger.data("popin");
                    var classname = this.$trigger.attr("data-popin-class") ? this.$trigger.data("popin-class") : "";
                    var locked = this.$trigger.attr("data-popin-locked") ? this.$trigger.attr("data-popin-locked") : false;
                    var params = {
                        url: url,
                        classname: classname,
                        globalClassname: "is-poping",
                        locked: locked,
                        callback: this.settings.callback
                    };
                    this.setPopin(params);
                    e.preventDefault();
                }
            }, this));
            this.$document.on("click", ".js-fog, .js-popin-close", $.proxy(this.unsetPopin, this));
        },
        setPopin: function(params) {
            if (!$(".js-fog").length) this.$body.append(this.settings.tplFog);
            if (params.globalClassname) this.$body.addClass(params.globalClassname); else this.$body.addClass("is-poping");
            this.$popin.addClass("is-loading");
            var tplPopinHead = params.tplPopinHead ? params.tplPopinHead : this.settings.tplPopinHead;
            var tplPopinFoot = params.tplPopinFoot ? params.tplPopinFoot : this.settings.tplPopinFoot;
            if (params.url) {
                $.get(params.url, $.proxy(function(html) {
                    this.$popin.attr("class", "js-popin " + params.classname);
                    setTimeout($.proxy(function() {
                        this.$popin.html(tplPopinHead + html + tplPopinFoot);
                        this.$popin.trigger("popin-ready");
                        if (params.globalClassname != "is-toasting") this.$body.removeClass("is-toasting");
                ...
                this.$popin.attr("class", "js-popin " + params.classname).html(tplPopinHead + params.html + tplPopinFoot);
                this.$popin.trigger("popin-ready");
                if (params.globalClassname != "is-toasting") this.$body.removeClass("is-toasting");
                if (params.callback) params.callback();
            }
            if (params.locked) this.lockPopin();
        },
        unsetPopin: function(e) {
            if (this.$popin) {
                if (!this.locked) {
                    this.$body.removeClass("is-poping is-toasting");
                    setTimeout($.proxy(function() {
                        this.$popin.empty();
                        this.$popin.trigger("popin-unload");
                    }, this), this.settings.transitionDuration);
                } else {
        ...
        lockPopin: function(e) {
            $("html").addClass("is-locked");
            this.locked = true;
        },
        unlockPopin: function(e) {
...
(function($, window, document, undefined) {
    var pluginName = "videoAutoplay", defaults = {
        param: "&autoplay=1"
    };
    function Plugin(element, options) {
        this.element = element;
    ...
    $.extend(Plugin.prototype, {
        ...
        setVars: function() {
            this.windowWidth = $(window).width();
            this.windowHeight = $(window).height();
            this.src = this.$element.attr("data-src") ? this.$element.attr("data-src") : this.$element.attr("src");
        },
        setAutoplay: function() {
            this.$element.attr("src", this.src + this.settings.param);
            this.src = this.$element.attr("src");
        },
        unsetAutoplay: function() {
            this.$element.attr("src", this.src.replace(this.settings.param, ""));
            this.src = this.$element.attr("src");
        },
        setEvents: function() {
            var scrollTop = $(window).scrollTop();
            $(window).on("scroll", $.proxy(function() {
                ...
                var scrollDelta = newScrollTop - scrollTop;
                scrollTop = newScrollTop;
                var videoTop = this.$element.offset().top;
                var videoHeight = this.$element.height();
                var videoBottom = videoTop + videoHeight;
                if (scrollTop + this.windowHeight >= videoTop && scrollTop <= videoBottom) {
                    if (this.src.indexOf(this.settings.param) == -1) this.setAutoplay();
                } else {
                    if (this.src.indexOf(this.settings.param) != -1) this.unsetAutoplay();
                }
            }, this));
...
(function($, window, document, undefined) {
    var pluginName = "videoFull", defaults = {
        apiKey: "2174731b9bb45d5c93d3",
        volume: .5,
        loop: true,
    ...
    $.extend(Plugin.prototype, {
        ...
        setVars: function() {
            this.windowWidth = $(window).width();
            this.windowHeight = $(window).height();
            this.id = this.$element.data("videofull-id");
        },
        setSize: function() {
            setTimeout($.proxy(function() {
                this.$element.css("height", this.windowWidth / (16 / 9) + "px");
                this.$element.parents(".js-screenHeight").css("height", this.windowWidth / (16 / 9) + "px");
            }, this), 200);
        },
        setVideo: function() {
            if (!this.player) {
                ...
                this.$element.append('<div id="DM_' + this.id + '"></div>');
                var params = {
                    api: 1,
                    autoplay: 1,
                    chromeless: 1,
                ...
                this.player = DM.player($("#DM_" + this.id).get(0), {
                    video: this.id,
                    width: "100%",
                    height: "100%",
                    params: params
                });
                this.player.init(this.id, params);
                $(this.player).bind("apiready", $.proxy(function() {
                    $(window).trigger("scroll");
                }, this));
                $(this.player).bind("timeupdate", $.proxy(function() {
                    this.settings.onTimeupdate();
                }, this));
                $(this.player).bind("ended", $.proxy(function() {
                    if (this.settings.loop) this.player.play(); else this.$element.animate({
                        opacity: 0
                    });
                }, this));
            }
        ...
        setEvents: function() {
            ...
            $(window).on("scroll", $.proxy(function() {
                ...
                var videoHeight = this.$element.height();
                var videoBottom = videoTop + videoHeight;
                if (scrollTop >= videoTop && scrollTop <= videoBottom) {
...
(function($, window, document, undefined) {
    var pluginName = "videoPlayer", defaults = {
        param: "&autoplay=1"
    };
    function Plugin(element, options) {
        this.element = element;
    ...
    $.extend(Plugin.prototype, {
        ...
        setElements: function() {
            ...
            this.$iframe = this.$cover.prev(".js-dmlazy");
        },
        setVars: function() {
            this.windowWidth = $(window).width();
            this.windowHeight = $(window).height();
            this.src = this.$iframe.attr("data-src") ? this.$iframe.attr("data-src") : this.$iframe.attr("src");
        },
        setEvents: function() {
            this.$cover.on("click", $.proxy(function() {
                this.$iframe.attr("src", this.src + this.settings.param);
                this.$cover.addClass("is-playing");
                setTimeout($.proxy(function() {
                    this.$cover.hide();
                }, this), 500);
            }, this));
...
(function($, window, document, undefined) {
    var pluginName = "colDiapo", defaults = {
        offsetTop: 100,
        tplImage: '<div class="js-colDiapo-item"><img src="{{image}}" class="" alt="" /></div>'
    };
    function Plugin(element, options) {
        this.element = element;
        this.settings = $.extend({}, defaults, options);
    ...
    $.extend(Plugin.prototype, {
        init: function() {
            ...
            this.$container.css({
                position: "relative",
                clear: "both"
            }).append('<div style="with:100%;height:1px;clear:both"></div>');
            this.setVars();
            this.setEvents();
            $(window).trigger("scroll");
        },
        setElements: function() {
            this.$element = $(this.element);
            this.$col = this.$element.parent("div");
            this.$container = this.$element.parents(".js-colDiapo-container");
        },
        setVars: function() {
            this.windowWidth = $(window).width();
            this.windowHeight = $(window).height();
            this.images = this.$element.data("images");
            this.legends = this.$element.data("legends") ? this.$element.data("legends") : [];
        ...
        setEvents: function() {
            ...
            $(window).on("scroll", $.proxy(function() {
                ...
                scrollTop = newScrollTop;
                var eleTop = this.$element.offset().top;
                var eleHeight = this.$element.outerHeight() + 30;
                var eleBottom = eleTop + eleHeight;
                var containerTop = this.$container.offset().top;
                var containerHeight = this.$container.height();
                var containerBottom = containerTop + containerHeight;
                if (scrollTop + this.windowHeight >= containerTop && scrollTop <= containerBottom) {
                    if (!this.$element.data("isLoaded")) this.initDiapo();
                    if (scrollTop + this.settings.offsetTop >= containerTop && this.$col.width() < this.$container.width()) {
                        if (scrollTop < containerBottom - eleHeight - this.settings.offsetTop) {
                            this.$element.css({
                                position: "fixed",
                                top: this.settings.offsetTop + "px",
                                bottom: ""
                            });
                            var scrollMiddle = scrollTop + this.windowHeight / 4;
                            var ratio = Math.floor((scrollMiddle - containerTop) * 100 / containerHeight);
                            var index = this.nbImages - Math.floor(ratio / (100 / this.nbImages)) - 1;
                            if (index >= 0 && index < this.nbImages) {
                                this.$items.filter(":eq(" + index + ")").css({
                                    opacity: 1
                                });
                                this.$items.filter(":gt(" + index + "), :lt(" + index + ")").css({
                                    opacity: 0
                                });
                            }
                        } else {
                    ...
                    } else if (this.$element.data("isLoaded")) {
            ...
            $(window).on("resize", $.proxy(function() {
                this.windowWidth = $(window).width();
                this.windowHeight = $(window).height();
                this.$element.removeData("isLoaded");
                $(window).trigger("scroll");
            }, this));
        },
        initDiapo: function() {
            for (var i in this.images) {
                if (!this.$element.find("[src='" + this.images[i] + "']").length && !this.$element.find("[data-src='" + this.images[i] + "']").length) {
                    var img = this.settings.tplImage.replace(/{{image}}/g, this.images[i]);
                    if (this.legends[i]) img = img.replace(/{{legend}}/g, this.legends[i]);
                    this.$element.prepend(img);
                }
            }
            this.$items = this.$element.find(".js-colDiapo-item");
            if (this.$col.width() < this.$container.width()) {
                this.$items.not(":last").css({
                    position: "absolute",
                    opacity: 0
                });
                this.$items.filter(":last").css({
                    position: "relative",
                    opacity: 1
                });
                this.$items.css({
...
(function($, window, document, undefined) {
    "use strict";
    var pluginName = "midDiapo", defaults = {
        tabElements: ".js-midDiapo-item",
        tabContentElements: ".js-midDiapo-content",
        tabContentBloc: ".js-midDiapo-container",
        tabActiveClass: "is-active",
        container: ".js-midDiapo-hscroll-mask",
        scroller: ".js-midDiapo-hscroll-list",
        controllerLeft: ".js-midDiapo-hscroll-left",
        controllerRight: ".js-midDiapo-hscroll-right",
        autoTab: true,
        imageRatio: 1.52126
    };
    function Plugin(element, options) {
    ...
    $.extend(Plugin.prototype, {
        init: function() {
            this.setElements();
            this.unsetEvents();
            this.unsetDefaultStyles();
            this.setVars();
            this.setDefaultStyles();
            this.maxItemIndex = this.getMaxItemIndex();
            this.toCenter();
            this.setControllers();
            this.setEvents();
            if (this.$tabs.filter("." + this.settings.tabActiveClass).length) this.$tabs.filter("." + this.settings.tabActiveClass).removeClass(this.settings.tabActiveClass).trigger("click"); else this.$tabs.first().trigger("click");
        },
        setElements: function() {
            this.$element = $(this.element);
            this.$container = this.$element.find(this.settings.container);
            this.$scroller = this.$element.find(this.settings.scroller);
            this.$items = this.$scroller.children();
            this.setActiveItem();
            this.$left = this.$element.find(this.settings.controllerLeft);
            this.$right = this.$element.find(this.settings.controllerRight);
        ...
        setActiveItem: function() {
            this.$activeItem = this.$items.filter("." + this.settings.tabActiveClass);
            this.activeItemIndex = this.$items.index(this.$activeItem);
        },
        setVars: function() {
            this.scrollerHeight = this.$items.filter(":first").outerHeight();
            var scrollerWidth = 0;
            this.$items.each(function() {
                scrollerWidth += $(this).outerWidth(true);
            });
            this.scrollerWidth = scrollerWidth;
            this.visibleWidth = this.$container.width();
            this.itemNum = this.$items.length;
            this.currentItemIndex = 0;
            this.tplDiapoFocus = $("#tpl-diapo-focus").html();
            Mustache.parse(this.tplDiapoFocus);
        },
        getMaxItemIndex: function() {
            var plugin = this;
            var maxItemIndex = this.itemNum - 1;
            return maxItemIndex;
        },
        setDefaultStyles: function() {
            ...
            this.$tabsContentBloc.css({
                minHeight: this.$tabsContentBloc.outerWidth() / this.settings.imageRatio
            });
        },
        unsetDefaultStyles: function() {
            this.$container.removeAttr("style");
            this.$scroller.removeAttr("style");
            this.$tabsContentBloc.removeAttr("style");
            this.$element.removeAttr("is-loaded");
        },
        setControllers: function() {
            if (!this.settings.autoTab) {
                if (this.currentItemIndex === 0) this.$left.addClass("is-disabled"); else if (this.$left.hasClass("is-disabled")) this.$left.removeClass("is-disabled");
                if (this.currentItemIndex >= this.maxItemIndex) this.$right.addClass("is-disabled"); else if (this.$right.hasClass("is-disabled")) this.$right.removeClass("is-disabled");
            } else {
                if (!this.activeItemIndex) this.$left.addClass("is-disabled"); else if (this.$left.hasClass("is-disabled")) this.$left.removeClass("is-disabled");
                if (!this.$items.eq(this.activeItemIndex + 1).length || this.scrollerWidth <= this.visibleWidth) this.$right.addClass("is-disabled"); else if (this.$right.hasClass("is-disabled")) this.$right.removeClass("is-disabled");
            }
        },
        setEvents: function() {
            this.$left.on("click", $.proxy(this.toPrev, this));
            this.$right.on("click", $.proxy(this.toNext, this));
            if ("ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0) {
                var touchStart = 0, touchEnd = 0, currentItemWidth = this.$items.eq(this.currentItemIndex).width(), _this = this;
                this.$scroller.on("touchstart", function(e) {
                    touchStart = e.originalEvent.touches[0].pageX;
                }).on("touchmove", function(e) {
                    touchEnd = e.originalEvent.touches[0].pageX;
                    if (touchStart - currentItemWidth >= touchEnd) {
                        _this.$right.first().trigger("click");
                        touchStart = touchEnd;
                        currentItemWidth = _this.$items.eq(_this.currentItemIndex).width();
                    } else if (touchStart + currentItemWidth <= touchEnd) {
                        _this.$left.first().trigger("click");
                        touchStart = touchEnd;
                        currentItemWidth = _this.$items.eq(_this.currentItemIndex).width();
                    }
                });
                this.$tabsContentBloc.on("touchstart", function(e) {
                    touchStart = e.originalEvent.touches[0].pageX;
                }).on("touchmove", function(e) {
                    touchEnd = e.originalEvent.touches[0].pageX;
                    if (touchStart - currentItemWidth >= touchEnd) {
                ...
                if (!this.xhr) {
                    ...
                    if (window.history.pushState && this.$tab.children("a") && this.$tab.children("a").attr("href").length > 1) {
                        ...
                        window.history.pushState({
                            tabIndex: tabIndex,
                            scrollTop: scrollTop
                        }, tabIndex, this.$tab.children("a").attr("href"));
                    }
                    this.toCenter();
                    this.setControllers();
                }
            ...
            $(window).on("keydown", $.proxy(function(e) {
                if (e.keyCode == 37) {
                    this.$left.first().trigger("click");
                } else if (e.keyCode == 39) {
                    this.$right.first().trigger("click");
                }
            }, this));
        },
        unsetEvents: function() {
            ...
            if ("ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0) {
                this.$scroller.off("touchstart").off("touchmove");
                this.$tabsContentBloc.off("touchstart").off("touchmove");
            }
            this.$tabs.off("click");
            $(window).off("popstate");
            $(window).off("keydown");
        ...
        toNext: function(e) {
            if (!this.$right.hasClass("is-disabled")) {
                this.setActiveItem();
                if (this.settings.autoTab && this.$items.eq(this.activeItemIndex + 1).length) {
                    this.activeItemIndex++;
                    this.$items.eq(this.activeItemIndex).trigger("click");
                }
            }
            e.preventDefault();
        },
        toPrev: function(e) {
            if (!this.$left.hasClass("is-disabled")) {
                this.setActiveItem();
                if (this.settings.autoTab && this.$items.eq(this.activeItemIndex - 1).length) {
                    this.activeItemIndex--;
                    this.$items.eq(this.activeItemIndex).trigger("click");
        ...
        toCenter: function() {
            ...
            if (this.$activeItem.length) {
                ...
                var visibleItems = Math.floor(this.visibleWidth / itemWidth);
                var itemOffset = Math.round((visibleItems - 1) / 2);
                if (this.activeItemIndex > itemOffset) {
                    var offsetIndex = this.activeItemIndex - itemOffset < this.maxItemIndex ? this.activeItemIndex - itemOffset : this.maxItemIndex;
                    this.slideTo(offsetIndex);
                } else {
                    this.slideTo(0);
                }
            }
        },
        slideTo: function(newItemIndex) {
            var offsetLeft = newItemIndex > 0 ? this.$items.eq(newItemIndex).position().left * -1 : 0;
            this.$scroller.css({
                left: offsetLeft
            });
        ...
        showContent: function(tabIndex) {
            if (!this.$tab.hasClass(this.settings.tabActiveClass)) {
                var prevTabIndex = this.$tabs.index(this.$tabs.filter("." + this.settings.tabActiveClass));
                ...
                var html = Mustache.render(this.tplDiapoFocus, {
                    src: this.$tab.data("focus-src"),
                    title: this.$tab.data("focus-title"),
                    description: this.$tab.data("focus-description"),
                    index: tabIndex + 1,
                    total: this.$tabs.length
                });
                if (prevTabIndex < tabIndex) this.$tabsContent.filter("[data-tabs-eq='" + prevTabIndex + "']").addClass("to-left"); else this.$tabsContent.filter("[data-tabs-eq='" + prevTabIndex + "']").addClass("to-right");
                if (this.$tabsContent.filter("[data-tabs-eq='" + tabIndex + "']").length) {
                    this.$tabsContent.filter("[data-tabs-eq='" + tabIndex + "']").removeClass("to-left to-right");
                } else {
                    this.$tabsContentBloc.append(html);
                    this.$tabsContent = this.$element.find(this.settings.tabContentElements);
                    this.$tabsContent.last().attr("data-tabs-eq", tabIndex);
                    if (prevTabIndex < tabIndex) this.$tabsContent.filter("[data-tabs-eq='" + tabIndex + "']").addClass("to-right").show(); else this.$tabsContent.filter("[data-tabs-eq='" + tabIndex + "']").addClass("to-left").show();
                    this.$tabsContent.filter("[data-tabs-eq='" + tabIndex + "']").find("img").on("load", $.proxy(function() {
...
(function($, window, document, undefined) {
    var pluginName = "scrollLateral", defaults = {
        margins: .05
    };
    function Plugin(element, options) {
        this.element = element;
    ...
    $.extend(Plugin.prototype, {
        ...
        setElements: function() {
            this.$element = $(this.element);
            this.$scrollContent = this.$element.find(".scrollLateral__content");
            this.$scrollResizable = this.$element.find(".scrollLateral__resizable");
        },
        setVars: function() {
            this.initialMarginTop = parseInt(this.$element.css("marginTop"));
            this.initialMarginLeft = parseInt(this.$element.css("marginLeft"));
            this.initialTop = parseInt(this.$element.position().top);
        },
        setSizes: function() {
            this.$scrollContent.css("height", $(window).height() - 2 * this.settings.margins * $(window).height());
            if (this.$scrollResizable.length > 0) {
                if (this.$scrollResizable.height() == 0) {
                    this.$scrollResizable.css("height", $(window).height());
                }
                rsz_w = parseInt("0" + this.$scrollResizable.attr("width"));
                rsz_h = parseInt("0" + this.$scrollResizable.attr("height"));
                if (rsz_w != 0 && rsz_h != 0) {
                    this.$scrollResizable.css("max-width", this.$scrollResizable.height() / rsz_h * rsz_w);
                }
                this.$scrollContent.css("width", this.$scrollResizable.height() / rsz_h * rsz_w);
            }
            this.$element.css("height", this.$scrollContent.width() - $(window).width() + $(window).height());
        },
        setEvents: function() {
            $(window).on("scroll", $.proxy(function() {
                var scrollTop = $(window).scrollTop();
                ...
                var elementBottom = this.$element.offset().top + elementHeight;
                differential = elementTop - scrollTop;
                if (differential <= 0 && differential >= $(window).width() - this.$scrollContent.width()) {
                    this.$scrollContent.addClass("fixed");
                    this.$scrollContent.css("top", this.settings.margins * $(window).height());
                    this.$scrollContent.css("bottom", "auto");
                    this.$scrollContent.removeClass("absbottom");
                    if (navigator.userAgent.indexOf("Chrome") > 0) {
                        this.$scrollContent.css({
                            left: differential + "px"
                        });
                    } else {
                        this.$scrollContent.css("left", differential + "px");
                    }
                } else {
                    this.$scrollContent.removeClass("fixed");
                    if (scrollTop > elementBottom - $(window).width()) {
                        this.$scrollContent.css("top", "auto");
                        this.$scrollContent.css("bottom", 2 * this.settings.margins * $(window).height());
                        this.$scrollContent.css("left", $(window).width() - this.$scrollContent.width() + "px");
                    } else {
                        this.$scrollContent.css("top", this.settings.margins * $(window).height());
                        this.$scrollContent.css("bottom", "auto");
...
$(document).ready(function() {
    ...
    var countdownStart = function() {
        ...
        $(".quiz .countdown").animate({
            opacity: 1
        });
        countdown = setInterval(function() {
            var deltaPixels = maxPixels * (maxSeconds - interval) / 1e3 / maxSeconds;
            backgroundPositionY = backgroundPositionY - deltaPixels / 4;
            $(".quiz #timer.countdown").css("background-position", "0 " + backgroundPositionY + "px");
            timeElapsed += interval;
            if (timeElapsed % 1e3 == 0) {
                var timeRemaining = maxSeconds - timeElapsed / 1e3;
                $(".quiz .countdown").html("<span>" + timeRemaining + "</span>");
                if (timeRemaining == 0) {
                    if (rep) displayReponse(); else saveReponse();
                }
            }
        }, interval);
    };
    var displayReponse = function(choice) {
        if (!choice) choice = -1;
        clearInterval(countdown);
        indexRep = rep[0] - 1;
        $(".quiz ul.reponses li:eq(" + indexRep + ")").addClass("right");
        indexChoice = choice - 1;
        if (choice == rep[0]) {
            $(".quiz ul.steps li.current").addClass("right").removeClass("current");
            var points = 10;
            var pointsAdded = 0;
            scoreup = setInterval(function() {
                var centaine = parseInt($(".quiz .score .points span:eq(0)").text());
                var dizaine = parseInt($(".quiz .score .points span:eq(1)").text());
                var unite = parseInt($(".quiz .score .points span:eq(2)").text());
                if (unite == 9) {
                    $(".quiz .score .points span:eq(2)").text(0);
                    if (dizaine == 9) {
                        $(".quiz .score .points span:eq(1)").text(0);
                        $(".quiz .score .points span:eq(0)").text(centaine + 1);
                    } else {
                        $(".quiz .score .points span:eq(1)").text(dizaine + 1);
                    }
                } else {
                    $(".quiz .score .points span:eq(2)").text(unite + 1);
                }
                pointsAdded++;
                if (pointsAdded == points) clearInterval(scoreup);
            }, 50);
        } else if (choice != -1) {
            $(".quiz ul.reponses li:eq(" + indexChoice + ")").addClass("wrong");
            $(".quiz ul.steps li.current").addClass("wrong").removeClass("current");
        } else {
            $(".quiz ul.steps li.current").addClass("wrong").removeClass("current");
        }
        $(".quiz .content .js-dmlazy").attr("src", rep[1]);
        $(".quiz span.reponses .total").text(parseInt($(".quiz span.reponses .total").text()) + 1);
        $(".quiz .content div.next").removeClass("disabled");
        $(".quiz ul.reponses").removeClass("active");
    };
    var saveReponse = function(choice) {
        if (!choice) choice = -1;
        indexChoice = choice - 1;
        if (choice != -1) {
            $(".quiz ul.reponses li:eq(" + indexChoice + ")").addClass("choice");
        }
        $(".quiz ul.steps li.current").addClass("done").removeClass("current");
        $(".quiz .content div.next").removeClass("disabled");
        $(".quiz ul.reponses").removeClass("active");
        var key = $(".quiz ul.reponses li:eq(" + indexChoice + ") input").val() ? $(".quiz ul.reponses li:eq(" + indexChoice + ") input").val() : choice;
        if (!$(".quiz").attr("key")) $(".quiz").attr("key", key); else $(".quiz").attr("key", $(".quiz").attr("key") + "," + key);
    };
    $(".quiz").on("click", ".start .play", function() {
        var blocWidth = $(".quiz .content").outerWidth();
        var nextXhr = $.ajax({
            url: "./includes/fr/quiz/question_1.html",
            type: "GET",
            dataType: "html",
            success: function(data) {
                $(".quiz .content div.next").addClass("disabled");
                $(".quiz .content").append(data);
                $(".quiz .content .reponses").show();
                rep = $(".quiz .question ul.reponses").attr("key") ? $(".quiz .question ul.reponses").attr("key").split("||") : null;
                if (rep) {
                    maxSeconds = parseInt($(".quiz .countdown").text());
                    countdownStart();
                }
            },
            complete: function() {
                $(".quiz .content .question").css({
                    left: blocWidth
                }).animate({
                    left: 0
                }, "fast", function() {
                    $(".quiz .content .question").removeAttr("style");
                });
                $(".quiz .tab .questions .current").text(1);
                $(".quiz ul.steps li:eq(0)").addClass("current");
                $(".quiz .start").hide();
                $(".section-quiz").show();
                $(window).trigger("resize");
            }
    ...
    $(".quiz").on("click", ".replay", function() {
        location.reload();
        return false;
    });
    $(".quiz").on("click touchstart", "ul.reponses li", function() {
        if (!$(this).parents("ul").hasClass("active")) return false;
        var index = $(this).index();
        if (rep) displayReponse(index + 1); else saveReponse(index + 1);
        return false;
    });
    $(".quiz").on("click", ".content div.next", function() {
        if ($(this).hasClass("disabled")) return false;
        var pointsHtml = $(".quiz .score .points").html();
        var blocWidth = $(".quiz .content").outerWidth();
        var nbQuestions = parseInt($(".quiz .tab .questions .total").text());
        if (parseInt($(".quiz .main .tab .current").text()) < nbQuestions) {
            var nextQuestion = parseInt($(".quiz .main .tab .current").text()) + 1;
            var nextQuestionIndex = nextQuestion - 1;
            $(".quiz .content .question").animate({
                left: -blocWidth
            }, "fast", function(e) {
                var nextXhr = $.ajax({
                    url: "./includes/fr/quiz/question_" + nextQuestion + ".html",
                    type: "GET",
                    dataType: "html",
                    success: function(data) {
                        $(".quiz .content div.next").addClass("disabled");
                        $(".quiz .content .question").remove();
                        $(".quiz .content").append(data);
                        $(".quiz .content .reponses").show();
                        rep = $(".quiz .question ul.reponses").attr("key") ? $(".quiz .question ul.reponses").attr("key").split("||") : null;
                    },
                    complete: function() {
                        ...
                        $(".quiz .tab .questions .current").text(nextQuestion);
                        if (rep) {
                            maxSeconds = parseInt($(".quiz .countdown").text());
                            $(".quiz .countdown").html("<span>" + maxSeconds + "</span>");
                            $(".quiz .countdown").removeAttr("style");
                            countdownStart();
                        }
                        $(".quiz ul.steps li:eq(" + nextQuestionIndex + ")").addClass("current");
                        if (nextQuestion == nbQuestions) $(".quiz .content .next span").text("Votre r̩sultat");
                        $(".quiz .score .points").html(pointsHtml);
                        $(window).trigger("resize");
                    }
                });
            });
            ...
            $(".quiz .content .question").animate({
                ...
                var score = parseInt($(".quiz .score .points").text());
                var nextXhr = $.ajax({
                    url: "./includes/fr/quiz/resultats.html",
                    type: "GET",
                    dataType: "html",
                    success: function(data) {
                        $(".quiz .content").html(data);
                        $(".quiz .caps, .quiz .embed").hide();
                        $(".quiz .content .resultats .score .num").text(score);
                    }
                });
            });
        }
...
if (typeof PopInAboOnly == "undefined") {
    var PopInAboOnly = null;
}

if (typeof _userInfos == "undefined") {
    var _userInfos = null;
}
...
var isSlowComputer = !isDesktop ? true : false;

var endIntro = function() {
    "use strict";
    var timeTaken;
    var start = +new Date();
    $(".intro-explore img").animate({
        opacity: 1
    }, 500, function() {
        ...
        if (document.location.hash && document.location.hash == "#slow") {
            isSlowComputer = true;
        }
        if (document.location.hash && document.location.hash == "#notslow") {
            isSlowComputer = false;
        }
        if (isSlowComputer) {
            document.body.className += " isSlowComputer";
        }
    });
    var pause = $("body.adsEnabled").length ? 5e3 : 2e3;
    setTimeout(function() {
        $(document).trigger("exploreReady");
        $("body").css("overflow-x", "hidden").css("overflow-y", "scroll");
        $("body").addClass("is-ready").trigger("scroll");
    }, pause);
};

var resizeVideos = function() {
    "use strict";
    $(".js-dmlazy:not(.js-infogedge)").each(function() {
        var width = Math.floor($(this).parent().width()) - 1;
...
var chargeFB = function() {
    ...
    (function(d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/fr_FR/all.js#xfbml=1&appId=261959740493169";
        fjs.parentNode.insertBefore(js, fjs);
    })(document, "script", "facebook-jssdk");
};

var chargeTwitter = function() {
    "use strict";
...
var smoothMouseWheel = function() {
    "use strict";
    var $body = $("html, body");
    var mouseWheelLast = 0;
    var mouseWheelLastValid = 0;
    var mouseWheelDuration = 500;
    var mouseWheelInterval = 50;
    ...
    $(window).on("mousewheel", function(e) {
        if (!isTrackPad) {
            if (parseInt(e.deltaFactor, 10) <= 10 || parseInt(e.deltaFactor, 10) >= 200) {
                isTrackPad = true;
                return false;
            }
            ...
            mouseWheelTimer = setTimeout(function() {
                if (Date.now() >= mouseWheelLastValid + mouseWheelDuration) {
                    var scrollTop = $(window).scrollTop();
                    var deltaY = e.deltaY * mouseWheelSize * Math.min(mouseWheelCount, 5) * -1;
                    $body.animate({
                        scrollTop: scrollTop + deltaY
                    }, mouseWheelDuration, "easeOutCubic");
                    mouseWheelLastValid = Date.now();
                    mouseWheelCount = 1;
                }
            }, mouseWheelInterval);
...
$(document).ready(function() {
    ...
    _popin = $(document).popin({
        transitionDuration: 200,
        tplPopinHead: '<a href="#" class="js-popin-close popin__close"></a>'
    }).data("plugin_popin");
    if (!isSlowComputer) {
        $(".js-videoFull").videoFull();
        $(".js-videoAutoplay").videoAutoplay();
    }
    $(".js-videoPlayer").videoPlayer();
    if (navigator.userAgent.indexOf("iPhone") > 0) {
        $(".imageChap--fixed").removeClass("imageChap--fixed");
    }
    chargeSocial();
    endIntro();
    $(window).on("resize", function() {
        WindowWidth = $(window).width();
        WindowHeight = $(window).height();
        $(".js-screenHeight").css("height", WindowHeight - $(".navbar").height());
        $(".js-screenHeightX2").css("height", WindowHeight * 2 - $(".navbar").height());
        resizeVideos();
        var screenOrientation = WindowWidth > WindowHeight ? "landscape" : "portrait";
        $("body").removeClass("landscape").removeClass("portrait").addClass(screenOrientation);
        if (_screenOrientation && _screenOrientation != screenOrientation) {}
    ...
    $(window).on("scroll", function() {
        ...
        $(".chapitre").each(function() {
            if ($(this).position().top - navHeight <= scrollTop) {
                chap_en_cours = parseInt($(this).attr("id").replace("CHAP", ""), 10);
            }
        });
        $("ul.nav li.surbrillance").removeClass("surbrillance");
        $("ul.nav li#LINK_" + chap_en_cours).addClass("surbrillance");
    });
    $(".nav li a").on("click", function(e) {
        var chap = $(this).attr("href");
        $("html,body").animate({
            scrollTop: $(chap).offset().top - $(".navbar").height() + 4
        }, 1);
        e.preventDefault();
    });
    if (($("body").hasClass("aboOnly") || PopInAboOnly) && navigator.userAgent.toUpperCase().indexOf("LEQUIPE") == -1) {
        document.cookie = "lequipe-connected-infos-qlf=; path=/; domain=www.lequipe.fr; expires=" + new Date(0).toUTCString();
        var cookiename = "lequipe-connected-infos";
        var url = document.location.href;
        if (url.indexOf("qlf-") != -1) {
            cookiename += "-qlf";
        }
        _userInfos = $.cookie(cookiename) ? jQuery.parseJSON($.cookie(cookiename)) : null;
        if (!_userInfos || _userInfos.quotiAbonne != 1) {
            PopInAboOnly.init();
                        ...
                        success: function(ret) {
                            if (ret.code != 200) {
                                ...
                                switch (ret.code) {
                                  case 511:
                                  case 513:
                                    errorTxt = "Votre adresse email ne semble pas ̻tre correcte.";
                                    break;

                                  case 514:
                                  case 517:
                                    errorTxt = "Votre mot de passe n'est pas renseign̩ ou trop court.";
                                    break;

                                  case 529:
                                    errorTxt = "L'association email/mot de passe ne correspond pas, veuillez v̩rifier vos identifiants.";
                                    break;

                                  default:
                                    errorTxt = "Une erreur s'est produite.";
                                    break;
                                }
                                $("#popinArticle .signin form .error").text(errorTxt).fadeIn();
                                $("#popinArticle .signin form a.submit").removeClass("disabled");
                            }
            ...
            $(document).on("click", "#popinArticle .signin form a.submit", function(e) {
                $("#popinArticle .signin form").trigger("submit");
                e.preventDefault();
            });
        }
    }
...
if (typeof isSlowComputer == "undefined") {
    var isSlowComputer = null;
}

$(document).ready(function() {
    "use strict";
    if (!isSlowComputer) {
        $(".js-classScrolling").addClassScrolling();
    } else {
        $(".js-classScrolling").addClass("is-active");
    }
    if (!isSlowComputer) {
        $(".js-quote").addClassScrolling({
            offset: 100,
            start: "bottom",
            repeat: true
        });
    } else {
        $(".js-quote").addClass("is-active");
    }
    setTimeout(function() {
        $(".js-scrollLateral").scrollLateral();
    }, 6e3);
    $("#CHAP02 .js-midDiapo").midDiapo({
        imageRatio: 1.11752988048
    });
    $("#CHAP04 .js-midDiapo").midDiapo({
        imageRatio: .80546075085
    });
    $("#CHAP03 .js-midDiapo").midDiapo({
        imageRatio: 1.7777
    });
});
